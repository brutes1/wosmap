...
# Feature colors for multi-color printing
FEATURE_COLORS = {
    'buildings': {'name': 'Buildings', 'color': '#CC4444', 'displaycolor': '#CC444480'},
    'roads': {'name': 'Roads', 'color': '#808080', 'displaycolor': '#80808080'},
    'water': {'name': 'Water', 'color': '#4488CC', 'displaycolor': '#4488CC80'},
    'parks': {'name': 'Parks', 'color': '#44AA44', 'displaycolor': '#44AA4480'},
    'rails': {'name': 'Rails', 'color': '#444444', 'displaycolor': '#44444480'},
    'base': {'name': 'Base', 'color': '#FFFFFF', 'displaycolor': '#FFFFFF80'},
}
...
def create_3mf_model_xml(objects: list, materials: list) -> str:
    ...
    for mat in materials:
        ...
        base.set('displaycolor', mat['displaycolor'])
