...
def create_bambu_project_settings() -> str:
    """Create minimal Bambu project settings."""
    return """; generated by WOSMap for Bambu Studio / OrcaSlicer
[project]
"""
...
def create_multicolor_3mf(stl_files: Dict[str, str], output_path: str) -> str:
    ...
    with zipfile.ZipFile(output_path, 'w', zipfile.ZIP_DEFLATED) as zf:
        ...
        zf.writestr('Metadata/project_settings.config', create_bambu_project_settings())
